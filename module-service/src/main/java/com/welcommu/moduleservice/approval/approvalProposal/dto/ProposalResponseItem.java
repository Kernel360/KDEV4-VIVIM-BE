...
@Getter
@Builder
public class ProposalResponseItem {
    ...
    public static ProposalResponseItem of(ApprovalProposal approvalProposal) {
        return ProposalResponseItem.builder().id(approvalProposal.getId())
            ...
            .progress(ProgressResponse.from(approvalProposal.getProjectProgress())).build();
    }
}

...
public class ApprovalProposalController {
    ...
    public ResponseEntity<ProposalResponseItemList> getApprovalList(@PathVariable Long progressId) {
        
        ProposalResponseItemList response = approvalProposalService.getAllProposal(progressId);
        return ResponseEntity.ok().body(response);
    }
